...
\end{figure*}
\clearpage
\todo{1) second camera screen goes to crop, but not add spot. Better to show it.
2) add arcs from Add Spot, 2nd crop, and email, and compare back to body screen
(or wherever they go).
3) Add 'Back' arcs to all relevant places.
4) Add labels to the arcs based on the button clicked.}
\begin{figure}
