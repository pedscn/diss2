...
\begin{enumerate}
    ...
    \item Design Iteration 5 - At this stage, there was the idea of adding color to the different body parts, indicating the separations even more, and replicating the design of the previous app \todo{Add reference to previous work}. The choice of which final design to use would be left in the hands of end-users, as shown later in section \todo{reference survey}, this would prove to be the superior and final design.
\end{enumerate}
...
Ideally, the tutorial would also contain guidance on operating within the app, however, this would go against material design guidelines \todo{Insert reference}, which suggest keeping tutorial screens between 4-6 pages. A well-designed app user interface should require minimal tutorial help for the app to be used.
...
As a recall from the technical requirements of the project, the goal was to develop an app that:
\begin{enumerate}
